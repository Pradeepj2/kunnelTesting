...
const StickyHeadTable = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_URL}/attendancemanage/concrete_approval_list `,
        Data,
        {
          headers: {
  ...
  const selectHandler = (row) => {
    let Data = {
      approved_concrete: true,
      approver_name_concrete: localStorage.getItem("user"),
    };
                        ...
                        <TableCell key="Options">
                          <span>
                            <Checkbox
                              ...
                              checked={row.approved_concrete}
                              disabled={row.approved_concrete}
                            />
                          </span>
                        </TableCell>
                      </TableRow>
