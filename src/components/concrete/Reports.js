...
const columns = [
  ...
  { id: "labourname", label: "Labourer Name" },
  { id: "date", label: "Date" },
  { id: "concrete_category", label: "Concrete Category" },
  { id: "concrete_load_capacity", label: "Concrete Load Capacity" },
  { id: "concrete_amount", label: "Concrete Amount" },
  { id: "selector_name_concrete", label: "Selector Name" },
  { id: "approver_name_concrete", label: "Approver Name" },
];
...
const StickyHeadTable = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_URL}/attendancemanage/concrete_reports `,
        Data,
        {
          headers: {
  ...
  const exportHandler = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/wagemanage/wages/labour_concrete_report/?fromdate=${fromdate}&todate=${todate} `,
      ...
      .then((response) => {
        ...
        fileSaver.saveAs(blob, "concrete_report.xlsx");
      });
  };
  return (
    <>
