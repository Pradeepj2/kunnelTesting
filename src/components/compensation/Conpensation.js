...
const columns = [
  ...
  { id: "attendence", lable: "Attendence", minWidth: 170, align: "left" },
  { id: "daily_rate", lable: "Daily Rate" },
  { id: "ot_hrs", lable: "OT Hrs" },
  { id: "h_wage", lable: "H Wage" },
];
const columns2 = [
  { id: "daily_rate", lable: "Daily Rate" },
  { id: "attendence", lable: "Attendence", minWidth: 170 },
...
const Compensation = (props) => {
  ...
  const [totalComponsation, setTotalComponsation] = useState("");
  const [ratio, setRatio] = useState("");
  const [totalHolidayCount, setTotalHolidayCount] = useState("");
  ...
  const onSubmit = () => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_URL}/wagemanage/labour_compensation`,
        Data,
        {
          headers: {
  ...
  return (
    <div className="subContent">
          ...
          <Form.Group>
            <div>
              ...
              <span style={{ fontWeight: "bolder" }}>
                <strong>{totalComponsation} Rs.</strong>
              </span>
            </div>
          </Form.Group>
        </Form.Row>
              ...
              {arr.length != 0
                ? arr.map((data, id) => (
                    <TableRow hover>
                      ...
                      <TableCell style={{ textAlign: "center" }}>
                        {[data.from_date, data.to_date].join("  -  ")}
                      </TableCell>
                      <TableCell style={{ textAlign: "center" }}>
                        {data.attendance}
                      </TableCell>
      ...
      {arr.length ? (
        ...
        >
          <p>
            Total Holiday Count : <strong>{totalHolidayCount}</strong>
          </p>
          <p>
            Total Compensation Calculated as per {ratio} :{" "}
            <strong>{totalComponsation} Rs.</strong>
          </p>
        </div>
      ) : null}
