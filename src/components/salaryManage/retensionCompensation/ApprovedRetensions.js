...
const StickyHeadTable = ({ retentionApprovedList }) => {
  const rows = retentionApprovedList;
  ...
  const approve = (data) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_URL}/wagemanage/retention/retention_payment/`,
        Data,
        {
          headers: {
...
const mapStateToProps = (state) => ({
  retentionApprovedList: state.retentionApprovedList,
});
