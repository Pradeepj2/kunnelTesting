...
const LateApprovalListModal = (props) => {
  ...
  useEffect(() => {
    let Data = { ...props.Data, labourer_id: props.labourerid };

    axios
      .post(
        `${process.env.REACT_APP_API_URL}/approvals/otapproval/late_deduction_detail/`,
        Data,
        {
          headers: {
  ...
  const exportHandler = () => {
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/wagemanage/wages/total_late_detailed/?fromdate=${props.start}&todate=${props.end}&siteid=${props.siteid}&labourerid=${props.labourerid}`,
    ...
    <>
      ...
      >
        ...
        <Modal.Body>
                        ...
                        return (
                          <>
                            ...
                            >
                              ...
                              <TableCell>{row.late_time}</TableCell>
          ...
          <Button
            style={{ marginTop: "2em" }}
            onClick={() => (list.length ? exportHandler() : null)}
          >
            Export To Excel
          </Button>
        </Modal.Body>
